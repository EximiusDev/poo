...
void Pantalla::Run(string Nom){ ///Con este metodo empiezo a correr el juego
	...
	Mundo1.Modificardatos(altura, ancho, nivelcero);
	Mundo1.Ver_niveles();
	Mundo1.Ver_Matriz_azar();
	
	TextureBloq Bloq(Mundo1.Ver_Matriz_Bloques(), altura, ancho, nivelcero, res_x, res_y);
