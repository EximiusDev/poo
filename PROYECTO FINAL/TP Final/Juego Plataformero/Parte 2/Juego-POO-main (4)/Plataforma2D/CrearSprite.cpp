...
Sprite CrearSprite::getSprW(int i,bool Flip){if(Flip){return WalkLeft[i].getSpr();}else{ return WalkRight[i].getSpr();}}
Sprite CrearSprite::getSprJ(int i,bool Flip){if(Flip){return JumpLeft[i].getSpr();}else{return JumpRight[i].getSpr();}}
Sprite CrearSprite::getSprI(int i,bool Flip){if(Flip){return IdleLeft[i].getSpr();}else{return IdleRight[i].getSpr();}}
